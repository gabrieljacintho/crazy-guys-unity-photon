...
namespace GabrielBertasso.ShopSystem
{
    public class ShopView : MonoBehaviour
    {
        ...
        private List<ProductModel> _localProducts = new List<ProductModel>();
        private List<ProductView> _productViews = new List<ProductView>();
        ...
        private void OnEnable()
        {
            ...
            {
                _shop.OnInitialized += ShopManager_OnInitialized;
            }

            _shop.OnPurchasesRestored += UpdateAllProductViews;
        ...
        private void ShopManager_OnInitialized()
        {
            ...
            _localProducts = GetProducts(_shop);
